...
const About =() => {
    return (
        <div>
        <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[729px]">
  <div className="w-[1440px] h-[729px] absolute left-0 top-0 overflow-hidden bg-white">
    <div className="w-[1440px] h-[729px] absolute left-0 top-0">
      <div className="w-[1440px] h-[700px] absolute left-0 top-0">
        <div className="w-[632px] h-[612px] absolute left-[742px] top-[117px]">
          ...
          >
            <circle cx="242.428" cy="242.031" r="242.031" fill="#FFE9EA" />
          </svg>
          <svg
            width={78}
            height={79}
            ...
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="38.6969" cy="39.6578" r="38.6969" fill="#FFE9EA" />
          </svg>
          <img
          ...
          <svg
            ...
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="15.5479" cy="15.7871" r="15.127" fill="#FFE9EA" />
          </svg>
          <svg
            width={16}
            height={16}
            ...
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="8.32264" cy="8.10731" r="7.38758" fill="#977DF4" />
          </svg>
          <svg
            width={16}
            height={16}
            ...
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="8.30897" cy="8.16688" r="7.38758" fill="#977DF4" />
          </svg>
        </div>
      </div>
      <div className="w-[1440px] h-[729px] absolute left-0 top-0 overflow-hidden" />
    </div>
    <div className="w-[1322px] h-[91px] absolute left-[59px] top-0 overflow-hidden">
      <div className="w-[1322px] h-[91px] absolute left-0 top-0 overflow-hidden">
        ...
        <div className="w-[815px] h-[58px] absolute left-[364px] top-4 overflow-hidden">
          <div className="flex justify-start items-center absolute left-0 top-[17px] overflow-hidden gap-[21px]">
            <div className="flex-grow-0 flex-shrink-0 w-[43px] h-6 relative overflow-hidden">
              <div className="w-[43px] h-6 absolute left-0 top-0 overflow-hidden">
                <Link href="/"> 
                <p className="absolute left-0 top-0 text-sm font-bold text-center text-neutral-500">
                  Home
                </p>
                </Link>
              </div>
    ...
    <div className="flex flex-col justify-start items-start w-[1050px] absolute left-[195px] top-[104px] overflow-hidden gap-20 py-28">
      <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-[30px]">
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[599px] relative overflow-hidden gap-[35px]">
          ...
          <p className="flex-grow-0 flex-shrink-0 w-[542px] text-[58px] font-bold text-left text-[#252b42]">
            ABOUT US
          </p>
          ...
          <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-2.5">
            <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 px-10 py-[15px] rounded-[5px] bg-[#23a6f0]">
              <Link href="Get Qoute Now">
...
<div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[1264px]">
  <div className="w-[1440px] h-[236px] absolute left-0 top-[729px] overflow-hidden bg-white">
    <div className="flex flex-col justify-start items-center w-[1440px] absolute left-0 top-0 overflow-hidden py-6">
      <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[1018px] gap-[60px]">
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[394px] gap-20 py-6">
          <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[394px] relative gap-6">
            <p className="flex-grow-0 flex-shrink-0 text-sm text-left text-[#e74040]">
              Problems trying
            </p>
            <p className="flex-grow-0 flex-shrink-0 w-[394px] text-2xl font-bold text-left text-[#252b42]">
              Met minim Mollie non desert Alamo est sit cliquey dolor do met sent.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[529px] relative overflow-hidden gap-[49px]">
  ...
  <div className="w-[1440px] h-[264px] absolute left-0 top-[965px] overflow-hidden bg-white">
    <div className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 gap-[50px] py-20">
      <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-[30px]">
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[238px] relative">
        ...
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[241px] relative">
          <p className="flex-grow-0 flex-shrink-0 text-[58px] font-bold text-center text-[#252b42]">
            150K
          </p>
          <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-neutral-500">
        ...
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-60 relative">
          <p className="flex-grow-0 flex-shrink-0 text-[58px] font-bold text-center text-[#252b42]">
            15
          </p>
          <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-neutral-500">
  ...
  <div className="w-[1440px] h-[764px] absolute left-0 top-[1229px] overflow-hidden bg-white">
    <div className="w-[1050px] h-[764px] absolute left-[195px] top-0 overflow-hidden">
      <div className="w-[989px] h-[540px] absolute left-[31px] top-28 overflow-hidden rounded-[20px] bg-white">
        <div className="w-[989px] h-[540px] absolute left-0 top-0 overflow-hidden">
          ...
          />
          <div
            className="w-[989px] h-[540px] absolute left-0 top-0 overflow-hidden"
            style={{
              background:
                "linear-gradient(to bottom, rgba(0,0,0,0) 14.58%, rgba(56,56,56,0.84) 100%)",
            }}
          />
        </div>
        <div className="flex justify-start items-center absolute left-[448px] top-56 overflow-hidden px-[36.79999923706055px] py-[34.79999923706055px] rounded-[73.6px] bg-[#23a6f0]">
          <svg
            width={20}
            height={24}
            viewBox="0 0 20 24"
...
<div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[826px]">
  <div className="w-[1440px] h-[826px] absolute left-0 top-[1993px] overflow-hidden bg-white">
    <div className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 overflow-hidden gap-28 py-28">
      <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[607px] overflow-hidden">
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[607px] relative overflow-hidden gap-2.5">
      ...
      <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-[30px]">
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 overflow-hidden">
          <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[316px] relative overflow-hidden bg-white">
            ...
            <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[316px] relative overflow-hidden gap-2.5 p-[30px]">
        ...
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[329px] overflow-hidden">
          <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[329px] relative overflow-hidden bg-white">
            <div className="self-stretch flex-grow-0 flex-shrink-0 h-[231px] relative overflow-hidden">
              <img
            ...
            <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[332px] relative overflow-hidden gap-2.5 p-[30px]">
              <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-[#252b42]">
                Username
              </p>
              <p className="flex-grow-0 flex-shrink-0 text-sm font-bold text-center text-neutral-500">
        ...
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[329px] overflow-hidden">
          <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[329px] relative overflow-hidden bg-white">
            ...
            <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[330px] relative overflow-hidden gap-2.5 p-[30px]">
              <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-[#252b42]">
                Username
              </p>
              <p className="flex-grow-0 flex-shrink-0 text-sm font-bold text-center text-neutral-500">
...
<div className="w-[1440px] h-[479px]">
  <div className="w-[1440px] h-[479px] absolute left-0 top-[2819px] overflow-hidden bg-neutral-50">
    <div className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 overflow-hidden gap-6 py-20">
      <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[864px] overflow-hidden">
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[864px] relative overflow-hidden gap-[30px]">
          <p className="flex-grow-0 flex-shrink-0 text-[40px] font-bold text-left text-[#252b42]">
      ...
      <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-[30px] py-[50px]">
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[153px] relative overflow-hidden">
          <svg
            width={103}
            height={35}
            viewBox="0 0 103 35"
        ...
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[146px] relative overflow-hidden">
          <svg
            width={84}
            height={59}
            viewBox="0 0 84 59"
        ...
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[152px] relative overflow-hidden">
          <svg
            width={102}
            height={75}
            viewBox="0 0 102 75"
        ...
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[151px] relative overflow-hidden">
          <svg
            width={103}
            height={43}
            viewBox="0 0 103 43"
...
<div className="w-[1440px] h-[636px]">
  <div className="w-[1440px] h-[636px] absolute left-0 top-[3298px] overflow-hidden bg-[#2a7cc7]">
    ...
    <div className="flex flex-col justify-start items-start absolute left-[195px] top-0 overflow-hidden py-28">
      <div className="flex justify-between items-center flex-grow-0 flex-shrink-0 w-[1050px] relative overflow-hidden">
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[438px] relative overflow-hidden gap-6">
          ...
          <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 px-10 py-[15px] rounded-[5px] border border-neutral-50">
            <Link href="Button">
        ...
        <div className="flex-grow-0 flex-shrink-0 w-[548px] h-[412px] relative overflow-hidden" />
      </div>
    </div>
  </div>
</div>
