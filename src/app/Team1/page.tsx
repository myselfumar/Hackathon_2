...
const Pricing =() => {
    return (
        <div>
            <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-96">
  <div className="w-[1440px] h-96 absolute left-0 top-0 overflow-hidden bg-white">
    <svg
      width={1440}
      height={352}
    ...
    >
      <g clipPath="url(#clip0_232_1005)">
        <rect width={1440} height={352} fill="white" fillOpacity="0.5" />
      </g>
      <defs>
    ...
    <div className="flex flex-col justify-start items-center w-[870px] absolute left-[285px] top-[104px] overflow-hidden py-[50px]">
      <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden">
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-4">
          ...
          <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-[15px] py-2.5">
            <Link href="Home">
...
<div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[1759px]">
  <div className="w-[1440px] h-[1759px] absolute left-0 top-[914px] overflow-hidden bg-white">
...
<div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[442px]">
  <div className="w-[1440px] h-[442px] absolute left-0 top-[2673px] overflow-hidden bg-white">
    <div className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 overflow-hidden gap-24 py-20">
      <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[607px] gap-9">
        <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-[30px]">
          ...
          <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-2.5">
            <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 h-[52px] relative overflow-hidden gap-2.5 px-10 py-[15px] rounded-[5px] bg-[#23a6f0]">
              <p className="flex-grow-0 flex-shrink-0 text-sm font-bold text-center text-white">
                Try it free now
              </p>
            </div>
          </div>
          <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative overflow-hidden gap-[34px] p-2.5">
            <svg
              width={30}
              height={25}
              viewBox="0 0 30 25"
