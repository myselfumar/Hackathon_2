...
export const Footer = () => {
  return (
    <div className="self-stretch flex-grow-0 flex-shrink-0 h-[488px]">
  <div className="w-[1440px] h-[488px] absolute bg-white">
    <div className="w-[1440px] h-[142px] absolute left-0 top-0 overflow-hidden bg-neutral-50">
      <div className="flex flex-col justify-start items-start w-[1050px] absolute left-[195px] top-0 overflow-hidden py-10">
        <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-[577.5px]">
          <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[236px] relative overflow-hidden gap-2.5">
          ...
          <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[236px] overflow-hidden">
    ...
    >
      <line y1="0.5" x2={1057} y2="0.5" stroke="#E6E6E6" />
    </svg>
    <div className="w-[1440px] h-[272px] absolute left-0 top-[142px] overflow-hidden bg-white">
      <div className="flex flex-col justify-start items-start w-[1050px] absolute left-[195px] top-0 overflow-hidden py-[50px]">
        <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 overflow-hidden gap-[30px]">
          <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[148px] relative overflow-hidden gap-5">
          ...
          <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[152px] relative overflow-hidden gap-5">
            <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-left text-[#252b42]">
              Legal
            </p>
            <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-2.5">
          ...
          <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[321px] relative overflow-hidden gap-5">
            <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-left text-[#252b42]">
              Get In Touch
            </p>
    ...
    <div className="w-[1440px] h-[74px] absolute left-0 top-[414px] overflow-hidden bg-neutral-50">
      <div className="flex flex-col justify-start items-start w-[1050px] absolute left-[195px] top-0 overflow-hidden py-[25px]">
        <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-[213px]">
          <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[600px] relative overflow-hidden">
            <p className="flex-grow-0 flex-shrink-0 text-sm font-bold text-left text-neutral-500">
